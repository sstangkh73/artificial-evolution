...
![Toxic-food intake reduction](figures/toxin_fig3_reduction.png)

**รูปที่ 6** การลดลงของการกินอาหารพิษสะสมตามเวลา เทียบ "ไม่มีกลไก" (เส้นเทา — กินทุกรอบ สะสมถึง 60) กับ "มีกลไก toxin" (เส้นเขียว — เรียนรู้แล้วหยุด นิ่งที่ 1) พื้นที่แรเงาคือมื้อพิษที่เลี่ยงได้ = **ลดลง 98% (เลี่ยงได้ 59 จาก 60 มื้อ)**
